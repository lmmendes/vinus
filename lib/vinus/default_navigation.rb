require 'vinus/navigation_manager'

# This file defines all the default navigation managers used in Vinus. Of course,
...
#
Vinus::NavigationManager.build(:admin_primary) do
  add_item :customers
  add_item :orders
  add_item :products
