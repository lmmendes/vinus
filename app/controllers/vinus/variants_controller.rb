module Vinus
  class VariantsController < ApplicationController
    ...
    def create
      ...
      if @variant.save
        redirect_to [@product, :variants], notice: t('vinus.variants.create_notice')
      else
        render action: 'form'
      end
    end
    ...
    def update
      if @variant.update(safe_params)
        redirect_to edit_product_variant_path(@product, @variant), notice: t('vinus.variants.update_notice')
      else
        render action: 'form'
      end
    end
    ...
    def destroy
      @variant.destroy
      redirect_to [@product, :variants], notice: t('vinus.variants.destroy_notice')
    end
