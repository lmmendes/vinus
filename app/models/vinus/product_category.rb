...
module Vinus
  class ProductCategory < ActiveRecord::Base
    ...
    self.table_name = 'vinus_product_categories'

    # Attachments for this product category
    has_many :attachments, as: :parent, dependent: :destroy, class_name: 'Vinus::Attachment'

    # All products within this category
    has_many :product_categorizations, dependent: :restrict_with_exception, class_name: 'Vinus::ProductCategorization', inverse_of: :product_category
    has_many :products, class_name: 'Vinus::Product', through: :product_categorizations
