module Vinus
  class TaxRate < ActiveRecord::Base
    self.table_name = 'vinus_tax_rates'

    include Vinus::AssociatedCountries
    ...
    has_many :products, dependent: :restrict_with_exception, class_name: 'Vinus::Product'

    # All delivery service prices which are assigned to this tax rate
    has_many :delivery_service_prices, dependent: :restrict_with_exception, class_name: 'Vinus::DeliveryServicePrice'
