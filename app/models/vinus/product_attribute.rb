module Vinus
  class ProductAttribute < ActiveRecord::Base
    self.table_name = 'vinus_product_attributes'
    ...
    def self.public
      ActiveSupport::Deprecation.warn('The use of Vinus::ProductAttribute.public is deprecated. use Vinus::ProductAttribute.publicly_accessible.')
      publicly_accessible
    end
  end
end
