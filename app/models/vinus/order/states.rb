module Vinus
  class Order < ActiveRecord::Base
    ...
    STATUSES = %w(building confirming received
                  accepted rejected shipped delivered).freeze

    # The Vinus::User who accepted the order
    #
    # @return [Vinus::User]
    belongs_to :accepter, class_name: 'Vinus::User', foreign_key: 'accepted_by'

    # The Vinus::User who rejected the order
    #
    # @return [Vinus::User]
    belongs_to :rejecter, class_name: 'Vinus::User', foreign_key: 'rejected_by'
