module Vinus
  class Payment < ActiveRecord::Base
    ...
    #
    # @return [Vinus::Payment]
    belongs_to :parent, class_name: 'Vinus::Payment', foreign_key: 'parent_payment_id'
    ...
    def refund!(amount)
      run_callbacks :refund do
        ...
        if refundable_amount >= amount
          ...
          fail Vinus::Errors::RefundFailed, message: I18n.t('.refund_failed', refundable_amount: refundable_amount)
        end
      end
    end
