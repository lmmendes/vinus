...
require 'vinus/version'

Gem::Specification.new do |s|
  s.name        = 'vinus'
  s.version     = Vinus::VERSION
  s.authors     = ['Luis Mendes']
  s.email       = ['luis.mendes@peculiar.wine']
  s.homepage    = 'http://github.com/peculiar.wine'
  ...
  s.add_dependency 'jquery-rails', '>= 4', '< 4.4'
